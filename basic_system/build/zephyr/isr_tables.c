...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[82] = {
	...
	{(const void *)0x8003d53, (ISR)0x8000e1d}, /* 6 */
	{(const void *)0x8003d51, (ISR)0x8000e1d}, /* 7 */
	{(const void *)0x8003d4f, (ISR)0x8000e1d}, /* 8 */
	{(const void *)0x8003d4d, (ISR)0x8000e1d}, /* 9 */
	{(const void *)0x8003d4b, (ISR)0x8000e1d}, /* 10 */
	...
	{(const void *)0x8003d49, (ISR)0x8000e1d}, /* 23 */
	...
	{(const void *)0x8003d47, (ISR)0x8000e1d}, /* 40 */
